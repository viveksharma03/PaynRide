...
mySlider.current.slickPrev()
    ...
    return (
        <div>
            <div  style={{display:'flex',justifyContent:'space-between',marginTop:10,marginBottom:25,width:'96%'}}>
                <span style={{color:'#95a5a6',fontWeight:'bolder',fontSize:28}}>{props.tittle}</span>
